...
{
    public abstract class JenkinsTryOutWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static JenkinsTryOutWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(JenkinsTryOutWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<JenkinsTryOutDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<JenkinsTryOutDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<JenkinsTryOutDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<JenkinsTryOutDbContext, Task<T>> func)
        {
            T result;
